      ...
      >
        ...
        {leftIcon && (
          <div className={cn(
            ...
            iconColor === "success" && "bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400",
            iconColor === "warning" && "bg-yellow-100 dark:bg-yellow-900/20 text-yellow-600 dark:text-yellow-400",
            iconColor === "info" && "bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400"
          )}>
            {leftIcon}
          </div>
        )}
