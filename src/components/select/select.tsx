  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex items-center justify-between gap-2 whitespace-nowrap data-[size=default]:h-9 data-[size=sm]:h-8",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-foreground-secondary px-2 py-1.5 text-xs", className)}
      {...props}
    />
  )
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "hover:bg-background-secondary focus:bg-background-secondary/50 focus:text-foreground-primary [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
