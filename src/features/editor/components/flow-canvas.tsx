  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex gap-1">
      {onAddArtboard && (
        ...
        >
          <Icon variant="plus" className="h-4 w-4" />
        </Button>
      )}
      <Button
          variant="primary"
        ...
        >
          <Icon variant="magnifier" className="h-4 w-4" />
        </Button>
        <Button
          variant="primary"
          semantic="default"
        ...
        >
          <Icon variant="window_magnifier" className="h-4 w-4" />
        </Button>
        <Button
          variant="primary"
          semantic="default"
        ...
        >
          {isInteractive ? <Icon variant="lock_close" className="h-4 w-4" /> : <Icon variant="lock_close" className="h-4 w-4" />}
        </Button>
    </div>
  );
}
